...
| Firehose             | Query, probe, or observe source-backed civic signals through snapshots, SSE, and WebSockets.    | [Firehose protocol](/api/guides/firehose)     |
...
Read [authentication](/api/authentication) before building anything that writes
...
<Card title="Understand place data" icon="map" href="/api/guides/places">
  Use profiles, coverage, signals, and source lists together.
</Card>

<Card title="Observe civic signals" icon="radio" href="/api/guides/firehose">
  Query snapshots, open streams, and keep protocol contracts in sync.
</Card>

<Card title="Generated reference" icon="code" href="/api/reference">
