...
<Tip>
You can retrieve the full taxonomy programmatically via `GET /api/issue-areas` and `GET /api/domains`. See the [taxonomy API guide](/api/guides/taxonomy) for request patterns.
</Tip>
...
<Card title="Taxonomy API guide" icon="code" href="/api/guides/taxonomy">
  Retrieve domains and issue areas from integrations.
</Card>

<Card title="Research a place" icon="map" href="/api/guides/places">
