...
<Tip>
You can retrieve the full taxonomy programmatically via `GET /api/issue-areas` and `GET /api/domains`. See the [taxonomy API guide](/api-reference/guides/taxonomy) for request patterns.
</Tip>
...
<Card title="Taxonomy API guide" icon="code" href="/api-reference/guides/taxonomy">
