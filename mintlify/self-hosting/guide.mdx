...
name. If Stripe blocks that metadata lookup, bootstrap asks you to confirm the
Stripe account ID instead. A live secret key also works, but restricted keys are
