...
| -------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| Public directory     | Search people, organizations, initiatives, campaigns, events, places, sources, and issue areas. | [Find actors](/api/guides/entities)           |
| Workspace workflows  | Build briefs, lists, watches, usage proof, private review, and Scout sync handoffs.             | [Workspace visibility](/api/guides/workspace) |
| Discovery and agents | Start hosted discovery runs, run Scout locally, or use MCP through an assistant.                | [Discovery and Scout](/api/guides/discovery)  |
...
Read [authentication](/api/authentication) before building anything
