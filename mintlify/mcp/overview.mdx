...
2. **Atlas Pro or Team plan** — MCP access requires a paid plan ([see pricing](/account/pricing)). Free-tier sign-ins can complete, but Atlas assistant capabilities stay unavailable until a plan is active.
