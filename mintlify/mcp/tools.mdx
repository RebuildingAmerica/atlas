...
<Note>
  ...
  [Scopes and permissions](/mcp/scopes), [Authentication](/api-reference/authentication),
...
<Card title="Discovery API guide" icon="terminal" href="/api-reference/guides/discovery">
