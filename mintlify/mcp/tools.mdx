...
Sync a reviewed Scout run artifact bundle into the active workspace after
confirmation. Synced runs and entries stay private to the workspace unless a
separate review path makes them public.

**Parameters:**
| Parameter | Type | Description |
|-----------|------|-------------|
| `artifacts` | object | Canonical Scout run artifact bundle |

**Example requests:**

- "Sync this reviewed Scout run to our workspace"
- "Import these reviewed Scout artifacts without publishing them"
