...
Read [Authentication](/api/authentication) for the difference between
...
- Upgrade to [Atlas Pro, Team, or Research Pass](/account/pricing) for higher limits
- Cache API responses to reduce requests

See [Rate limits](/api/rate-limits) for limits by access pattern.
...
For local searches, compare your request with [Research a place](/api/guides/places)
...
- Free accounts don't have API key access — you need [Atlas Pro, Team, or Research Pass](/account/pricing)
