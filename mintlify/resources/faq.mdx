...
<Accordion title="How do I get API access?">
  ...
  need [Atlas Pro, Atlas Team, or a Research Pass](/account/pricing) and an API
...
<Accordion title="How do I connect an AI assistant?">
  ...
  overview](/mcp/overview). MCP requires Atlas Pro, Atlas Team, or a Research
  Pass.
</Accordion>
...
<Accordion title="What's the Research Pass?">
  ...
  accessible read-only. See [Plans & pricing](/account/pricing).
</Accordion>
