...
/**
 * Lets organization owners and admins select the workspace's public ATProto
 * identity without transferring their underlying personal DID control.
 */
    ...
    <section className="border-border bg-surface-container-lowest space-y-4 rounded-lg border p-5">
      ...
      <div className="border-border bg-surface-container-low rounded-lg border p-4">
        ...
        <p className="type-body-small text-ink-soft mt-1">
          Create an Atlas-managed identity on the Atlas PDS, then attach it to this organization.
        </p>
      ...
      <div className="space-y-3">
        <div>
          <h4 className="type-title-small text-ink-strong">Use an existing controlled identity</h4>
          <p className="type-body-small text-ink-soft mt-1">
        ...
        <div className="border-border space-y-4 border-t pt-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="type-body-small text-ink-soft mt-1">
                Let a workspace member administer this identity until an owner or admin revokes it.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
              <label className="type-body-small text-ink-strong min-w-0 flex-1">
