...
describe("profile showcase primitives", () => {
  it("frames profile overviews as research records rather than directories", () => {
    expect(buildScopeCopy("people").description).toContain(
      "People working across public record, place, and issue.",
    );
    ...
    expect(buildScopeCopy("all").description).toContain(
      "Explore people and organizations by issue, place, and public record.",
    );
