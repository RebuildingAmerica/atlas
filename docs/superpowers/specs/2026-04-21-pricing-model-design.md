...
test and live runs produce different IDs:
...
STRIPE_PRICE_ATLAS_PRO_STUDENT_FOUR_MONTH=<mode-specific>
...
STRIPE_COUPON_STUDENT=<mode-specific>
STRIPE_COUPON_JOURNALIST=<mode-specific>
STRIPE_COUPON_NONPROFIT=<mode-specific>
STRIPE_COUPON_CIVIC_TECH=<mode-specific>
```
