...
- [Atlas Scout CLI Worker Auth And Discovery Spec](2026-07-04-atlas-scout-cli-worker-discovery.md) (2026-07-04) — Turnkey Scout login, worker enrollment, upload destinations, sync receipts, web handoff, search connection behavior, and the review-gated discovery contribution model.
