...
export function formatCloudflareTokenPromptMessage(
  ...
  return [
    ...
    "8. Leave Client IP Address Filtering empty unless Atlas explicitly needs a locked-down operator IP.",
    "9. Continue to summary, create the token, and copy the token value. Cloudflare shows it once.",
    "",
